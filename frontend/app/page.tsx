...
export default function HomePage() {
  return (
    <main style={s.page} className="surface-texture-fine">
      ...
      <div style={s.container}>
        ...
        {/* Roadmap */}
        <section id="roadmap" style={s.roadmap} className="texture-surface-1">
          <div style={s.sectionHeader}>
...
const s = {
  ...
  noise: {
    ...
    bottom: 0,
    background: `
      var(--texture-bg-noise),
      var(--texture-grain),
      radial-gradient(circle at 25% 25%, rgba(180, 199, 231, 0.02) 0%, transparent 50%),
      radial-gradient(circle at 75% 75%, rgba(196, 231, 212, 0.015) 0%, transparent 50%),
      radial-gradient(circle at 50% 10%, rgba(212, 208, 231, 0.012) 0%, transparent 40%),
      radial-gradient(circle at 10% 90%, rgba(231, 215, 196, 0.018) 0%, transparent 45%)
    `,
